...
public class DynamicAllFragment extends BaseNormalFragment implements OnItemClickListener, IDynamicController {
    ...
    public void initSubView(Bundle savedInstanceState) {
        ...
        mDynamicBusiness.getDynamicList(IDynamicBusiness.Dynamic_Action.list_group, gid, "", mNextPage);
    }
