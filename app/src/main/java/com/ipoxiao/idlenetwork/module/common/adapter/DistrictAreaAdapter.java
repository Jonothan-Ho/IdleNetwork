 ...
 */
public class DistrictAreaAdapter extends BaseAdapter<Area, DistrictAreaAdapter.ViewHolder> {


    public DistrictAreaAdapter(Context context) {
        super(context);
    }
    ...
    public void onBindViewHolder(Area bean, ViewHolder holder, final int position) {
        ...
        if (bean.getIs_trade() == 0) {
            holder.mTextName.setText(bean.getName()+"(没有行业)");
        } else {
