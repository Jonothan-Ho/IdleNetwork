...
import com.ipoxiao.idlenetwork.widget.DemoApplication;
...
public class CameraHelper implements PreviewCallback {
    ...
    boolean isScreenOriatationPortrait() {
        return IdleApplication.getInstance().getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
